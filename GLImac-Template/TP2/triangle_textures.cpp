...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Image> imagePtr = loadImage("/home/6im2/mkouyate/Documents/Marco/TP-OpenGL/GLImac-Template/assets/textures/triforce.png");
    if(imagePtr == NULL) {
        std::cout << "erreur de chargement de triforce.png" <<std::endl;
    } else {
        std::cout << "chargement triforce.png" <<std::endl;
    }
    ...
    std::cout << imagePtr->getPixels() <<std::endl;
    ...
    std::cout << "Debug du Uniform Location : " << uTextureLoc << std::endl;
        ...
        //====== REMPLIR LE VBO ====
        Vertex2DUV vertices[] = { Vertex2DUV(glm::vec2(0.0f,1.0f),glm::vec2(0.5f,0.0f)), Vertex2DUV(glm::vec2(-1.0f,-1.0f),glm::vec2(0.0f,1.0f)), Vertex2DUV(glm::vec2(1.0f,-1.0f),glm::vec2(1.0f,1.0f)) };
        ...
        glVertexAttribPointer(VERTEX_ATTR_TEXTURE, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex2DUV), (const GLvoid *)offsetof(Vertex2DUV,_coordTex));
