...
int main(int argc, char** argv) {
    ...
    while(!done) {
	    ...
	    glm::mat4 globalMVMatrix = glm::translate(glm::mat4(1), glm::vec3(0, 0, -5));
        ...
        for (unsigned int i = 0; i < nbrMoons; i++){
			glm::mat4 moonMVMatrix = glm::rotate(globalMVMatrix, windowManager.getTime(), moonAxes.at(i)); // Translation * Rotation
